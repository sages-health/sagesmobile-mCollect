 ...
 */
public class InstanceChooserListSages extends ListActivity {
...
//        String[] selectionArgs = {InstanceProviderAPI.STATUS_SUBMITTED};
        String[] selectionArgs = {"mock"};
        String sortOrder = InstanceColumns.LAST_STATUS_CHANGE_DATE + " DESC, " + InstanceColumns.STATUS + " DESC, " + InstanceColumns.DISPLAY_NAME + " ASC";
